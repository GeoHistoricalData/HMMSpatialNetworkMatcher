...
public class StraightnessCentralityVisitor extends LocalMorphologicalIndicator {
  public StraightnessCentralityVisitor() {
    super();
  }
  ...
  public void calculate(GeometricalGraph g) {
    ...
    sp.reset();
    g.updateCentralityValues(LocalMorphologicalndicatorList.STRAIGHTNESS,
        values);
    values = null;
    System.gc();
  }
