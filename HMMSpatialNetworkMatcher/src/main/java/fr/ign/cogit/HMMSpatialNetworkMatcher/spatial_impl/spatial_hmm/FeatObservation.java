...
/**
 * Implementation of AbstractObservation for spatial networks.
 * Decorator pattern on IFeature
 * @author bcostes
 *
 */
public class FeatObservation extends AbstractObservation implements IFeature{

  /**
   * IFeature wrapped in this observation.
   */
  private IFeature feature;


  public FeatObservation(IGeometry geom) {
  ...
  public String toString() {
    return "Feature observation : " + this.getGeom().toString();
  }
  ...
  public boolean equals(Object o) {
    ...
    if(! (o instanceof FeatObservation)) {
      return false;
    }
    FeatObservation s = (FeatObservation)o;
